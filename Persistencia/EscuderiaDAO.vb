Public Class EscuderiaDAO
    ...
    Public Function Insertar(ByVal p As Escuderia) As Integer
        Return AgenteBD.ObtenerAgente.Modificar("INSERT INTO escuderias (NombreEscuderia,PaisEscuderia,FechaCreacion) VALUES ('" & p.Nombre & "', '" & p.PaisEscuderia.IDPais & "', '" & p.FechaCrec.ToString("yyyy-MM-dd") & "');")
    End Function
